...
class AactiveToDos extends React.Component{
        ...
        return(
            <View style={{flex:1}}>
                ...
                <View style={{flex:1, justifyContent: 'center', alignItems:'center'}}>
                    <Text style={{color:'black', fontWeight:'bold', fontSize:18}}>Active Notes</Text>
                </View>
                ...
                <View style={{flex:9}}>
                    ...
                    {activeNotes ? 
                        ...
                        :
                        <View style={{flex:1, justifyContent: 'center', alignItems: 'center'}}>
                            <Text style={{fontSize:18, color: 'silver'}}>Oh ooo.... No active notes are there.</Text>
                        </View>
                    }    
...
export default connect(mapStateToProps, mapDispatchToProps)(AactiveToDos);
// export default AactiveToDos;